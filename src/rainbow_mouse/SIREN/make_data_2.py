...
from rainbow_mouse.SIREN.lib import train_cebra_time_relu
train_cebra_time_relu(lfp_data, 95, 100, 3, num_layers=3, epochs=1000, batch_size=128, learning_rate=1e-3)
